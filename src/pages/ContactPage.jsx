...
export default function ContactPage() {
    ...
    return (
        <div className="w-full px-10 lg:px-20 animate-entry-fade pb-20">
            ...
            {/* Hero Section */}
            <section ref={heroRef} className="mt-[100px] animate-on-scroll">
                <h1 className="text-[80px] font-medium tracking-[-2px] leading-[1]">
                    Let's Talk
                </h1>
                <p className="text-[#878686] text-[16px] leading-[1.7] mt-8 max-w-[600px]">
            ...
            {/* Contact Info Bar */}
            <div className="mt-20 py-8 flex items-center justify-between animate-entry-slide delay-200">
                {/* Book a Call Button */}
                <a
                    href="mailto:garkotinikhil247@gmail.com"
                    className="flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#82ff1d] text-black font-semibold text-sm hover:bg-white transition duration-300 cursor-pointer"
                >
                    <i className="fa-solid fa-video text-xs"></i>
                    Book a Call
                </a>

                <div className="flex-1 h-px bg-[#262626] mx-8" />
            ...
            {/* Form Section */}
            <section ref={formRef} className="mt-24 flex gap-20 animate-on-scroll">
                {/* Left - Heading */}
                <div className="flex-1 pt-4">
                    <h2 className="text-[42px] font-medium leading-[1.2] tracking-[-1px]">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="w-full bg-[#141414] border border-white/5 rounded-xl px-5 py-3.5 text-white text-sm placeholder-[#555] outline-none focus:border-white/20 transition duration-300"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                required
                                rows={6}
                                className="w-full bg-[#141414] border border-white/5 rounded-xl px-5 py-3.5 text-white text-sm placeholder-[#555] outline-none focus:border-white/20 transition duration-300 resize-none"
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full py-4 rounded-full bg-white text-black font-semibold text-sm hover:bg-[#82ff1d] transition duration-300 cursor-pointer"
                        >
                            Send Message
                        </button>
                    </form>
